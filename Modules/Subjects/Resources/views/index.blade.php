...
<div class="panel panel-default">
	<div class="panel-body">
		<a class="btn btn-info formbtn pull-right add-btn" href="/subjects/new">
            <i class="fa fa-plus-circle"></i><span class="btntitle"> Add New Subject</span>
        </a>
						...
						<tbody>
							...
							<tr>
								...
								<td>
                                    ...
                                    <a href="/subjects/edit?id=<?php echo $result->id; ?>" class="btn btn-default viewbtn"><i class="fa fa-pencil"></i></a>
								</td>
							</tr>
							<?php endforeach;?>
						</tbody>
